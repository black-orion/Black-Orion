namespace UBO.Editoren.Drop
{
	public partial class Drop
	{
		...
		private void InitializeComponent()
		{
			...
			this.lv_dropSPC.UseCompatibleStateImageBehavior = false;
			...
			this.lv_dropKind.UseCompatibleStateImageBehavior = false;
			...
			this.lv_dropItem.UseCompatibleStateImageBehavior = false;
