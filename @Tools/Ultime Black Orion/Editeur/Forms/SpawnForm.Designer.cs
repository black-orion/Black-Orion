...
namespace UBO
{
	partial class SpawnForm
	{
		...
		private void InitializeComponent()
		{
			...
			lbl_AggroChance.Text = "Chance Aggro";
			// 
			// lbl_RespawnZeit
			// 
			...
			lbl_RespawnZeit.Text = "Temps de Respawn :";
			// 
			// lbl_Gebiet
			// 
			...
			this.cb_move.UBOVisualStyleBackColor = true;
			// 
			// txt_RespawnZeit
			// 
			...
			this.lv_movers.BeforeLabelEdit += new System.Windows.Forms.LabelEditEventHandler(this.lv_moversBeforeLabelEdit);
			// 
			// SpawnForm
			// 
			...
			this.Name = "SpawnForm";
			this.Load += new System.EventHandler(this.SpawnFormLoad);
