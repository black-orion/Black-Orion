...
namespace UBO.Editoren.Forms
{
	partial class NPCForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.group_npcDaten.Text = "NPC Daten";
			// 
			// txt_id
			// 
			...
			this.cmd_ItemAdd.UBOVisualStyleBackColor = true;
			...
			this.cmd_ItemRm.Text = "Supprimet";
			this.cmd_ItemRm.UBOVisualStyleBackColor = true;
			...
			this.group_text.Text = "Text dans la bulle";
			// 
			// cmd_TextAdd
			// 
			...
			this.cmd_TextAdd.UBOVisualStyleBackColor = true;
			...
			this.cmd_TextRm.UBOVisualStyleBackColor = true;
			...
			this.lv_texte.UBOCompatibleStateImageBehavior = false;
			...
			this.cmd_TextChange.Text = "Ajouter";
			this.cmd_TextChange.UBOVisualStyleBackColor = true;
